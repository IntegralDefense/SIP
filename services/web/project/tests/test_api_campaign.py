...
class TestCampaign(BaseTestCase):
    """ Tests for the Campaign API calls """
    ...
    def test_create_duplicate_name(self):
        ...
        with self.client:
            ...
            self.assertEqual(response['message'], 'Campaign already exists')
    ...
    def test_read_nonexistent_id(self):
        ...
        with self.client:
            ...
            request = self.client.get('/api/campaigns/100')
            response = json.loads(request.data.decode())
            self.assertEqual(request.status_code, 404)
            self.assertEqual(response['message'], 'Campaign ID not found')
    ...
    def test_read_missing_api_key(self):
        ...
        with self.client:
            ...
            request = self.client.get('/api/campaigns/1')
            response = json.loads(request.data.decode())
            self.assertEqual(request.status_code, 401)
            self.assertEqual(response['message'], 'Bad or missing API key')
    ...
    def test_read_invalid_api_key(self):
        ...
        with self.client:
            ...
            request = self.client.get('/api/campaigns/1?apikey={}'.format(TEST_INVALID_APIKEY))
            response = json.loads(request.data.decode())
            self.assertEqual(request.status_code, 401)
            self.assertEqual(response['message'], 'API user does not exist')
    ...
    def test_read_invalid_role(self):
        ...
        with self.client:
            ...
            request = self.client.get('/api/campaigns/1?apikey={}'.format(TEST_ANALYST_APIKEY))
            response = json.loads(request.data.decode())
            self.assertEqual(request.status_code, 401)
            self.assertEqual(response['message'], 'Insufficient privileges')
    ...
    def test_read_all_values(self):
        ...
        with self.client:
            ...
            data = {'apikey': TEST_ANALYST_APIKEY, 'name': 'asdf3'}
            request = self.client.post('/api/campaigns', data=data)
            self.assertEqual(request.status_code, 201)

            request = self.client.get('/api/campaigns')
            response = json.loads(request.data.decode())
    ...
    def test_update_nonexistent_id(self):
        ...
        with self.client:
            ...
            data = {'apikey': TEST_ANALYST_APIKEY, 'name': 'asdf'}
            request = self.client.put('/api/campaigns/100', data=data)
            response = json.loads(request.data.decode())
            self.assertEqual(request.status_code, 404)
            self.assertEqual(response['message'], 'Campaign ID not found')
    ...
    def test_update_duplicate_value(self):
        ...
        with self.client:
            ...
            data = {'apikey': TEST_ANALYST_APIKEY, 'name': 'asdf'}
            request = self.client.put('/api/campaigns/1', data=data)
            response = json.loads(request.data.decode())
            self.assertEqual(request.status_code, 409)
            self.assertIn(response['message'], 'Campaign already exists')
    ...
    def test_delete_nonexistent_id(self):
        ...
        with self.client:
            ...
            request = self.client.delete('/api/campaigns/100', data=data)
            response = json.loads(request.data.decode())
            self.assertEqual(request.status_code, 404)
            self.assertEqual(response['message'], 'Campaign ID not found')
    ...
    def test_delete_missing_api_key(self):
        ...
        with self.client:
            ...
            request = self.client.delete('/api/campaigns/100')
            response = json.loads(request.data.decode())
            self.assertEqual(request.status_code, 401)
            self.assertEqual(response['message'], 'Bad or missing API key')
    ...
    def test_delete_invalid_api_key(self):
        ...
        with self.client:
            ...
            request = self.client.delete('/api/campaigns/1', data=data)
            response = json.loads(request.data.decode())
            self.assertEqual(request.status_code, 401)
            self.assertEqual(response['message'], 'API user does not exist')
