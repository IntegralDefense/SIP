...
class TestTag(BaseTestCase):
    ...
    def test_create_missing_value(self):
        ...
        with self.client:
            ...
            request = self.client.post('/api/tags', data=data)
    ...
    def test_create_duplicate_value(self):
        ...
        with self.client:
            ...
            self.assertEqual(response['message'], 'Tag already exists')
    ...
    def test_read_nonexistent_id(self):
        ...
        with self.client:
            ...
            request = self.client.get('/api/tags/100')
            response = json.loads(request.data.decode())
            self.assertEqual(request.status_code, 404)
            self.assertEqual(response['message'], 'Tag ID not found')
    ...
    def test_read_missing_api_key(self):
        ...
        with self.client:
            ...
            request = self.client.get('/api/tags/1')
            response = json.loads(request.data.decode())
            self.assertEqual(request.status_code, 401)
            self.assertEqual(response['message'], 'Bad or missing API key')
    ...
    def test_read_invalid_api_key(self):
        ...
        with self.client:
            ...
            request = self.client.get('/api/tags/1?apikey={}'.format(TEST_INVALID_APIKEY))
            response = json.loads(request.data.decode())
            self.assertEqual(request.status_code, 401)
            self.assertEqual(response['message'], 'API user does not exist')
    ...
    def test_read_invalid_role(self):
        ...
        with self.client:
            ...
            request = self.client.get('/api/tags/1?apikey={}'.format(TEST_ANALYST_APIKEY))
            response = json.loads(request.data.decode())
            self.assertEqual(request.status_code, 401)
            self.assertEqual(response['message'], 'Insufficient privileges')
    ...
    def test_update_nonexistent_id(self):
        ...
        with self.client:
            ...
            data = {'apikey': TEST_ANALYST_APIKEY, 'value': 'asdf'}
            request = self.client.put('/api/tags/100', data=data)
            response = json.loads(request.data.decode())
            self.assertEqual(request.status_code, 404)
            self.assertEqual(response['message'], 'Tag ID not found')
    ...
    def test_update_missing_value(self):
        ...
        with self.client:
            ...
            data = {'apikey': TEST_ANALYST_APIKEY}
            request = self.client.put('/api/tags/1', data=data)
            response = json.loads(request.data.decode())
            self.assertEqual(request.status_code, 400)
            self.assertEqual(response['message'], 'Request must include "value"')
    ...
    def test_update_duplicate_value(self):
        ...
        with self.client:
            ...
            response = json.loads(request.data.decode())
            self.assertEqual(request.status_code, 409)
            self.assertIn(response['message'], 'Tag already exists')
    ...
    def test_delete_nonexistent_id(self):
        ...
        with self.client:
            ...
            request = self.client.delete('/api/tags/100', data=data)
            response = json.loads(request.data.decode())
            self.assertEqual(request.status_code, 404)
            self.assertEqual(response['message'], 'Tag ID not found')
    ...
    def test_delete_missing_api_key(self):
        ...
        with self.client:
            ...
            request = self.client.delete('/api/tags/100')
            response = json.loads(request.data.decode())
            self.assertEqual(request.status_code, 401)
            self.assertEqual(response['message'], 'Bad or missing API key')
    ...
    def test_delete_invalid_api_key(self):
        ...
        with self.client:
            ...
            request = self.client.delete('/api/tags/1', data=data)
            response = json.loads(request.data.decode())
            self.assertEqual(request.status_code, 401)
            self.assertEqual(response['message'], 'API user does not exist')
